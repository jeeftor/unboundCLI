...
func TestAdguardClient_AddRewrite(t *testing.T) {
	...
	// Test AddRewrite
	err := client.AddRewrite("test.vookie.net", "10.0.0.15")
	if err != nil {
...
func TestAdguardClient_ListRewrites(t *testing.T) {
	...
	testRewrites := []Rewrite{
		{Domain: "test1.vookie.net", Answer: "10.0.0.15"},
		{Domain: "test2.vookie.net", Answer: "10.0.0.15"},
	}
...
func TestAdguardClient_UpdateRewrite(t *testing.T) {
	...
	// Test UpdateRewrite
	target := Rewrite{Domain: "old.vookie.net", Answer: "10.0.0.15"}
	update := Rewrite{Domain: "new.vookie.net", Answer: "10.0.0.16"}
...
func TestAdguardClient_DeleteRewrite(t *testing.T) {
	...
	// Test DeleteRewrite
	err := client.DeleteRewrite("test.vookie.net", "10.0.0.15")
	if err != nil {
...
func TestAdguardClient_RewriteExists(t *testing.T) {
	// Create test response data
	testRewrites := []Rewrite{
		{Domain: "existing.vookie.net", Answer: "10.0.0.15"},
		{Domain: "another.vookie.net", Answer: "10.0.0.16"},
	}
	...
	exists, err := client.RewriteExists("existing.vookie.net", "10.0.0.15")
	if err != nil {
	...
	exists, err = client.RewriteExists("nonexistent.vookie.net", "10.0.0.15")
	if err != nil {
		t.Errorf("RewriteExists failed: %v", err)
	}
	if exists {
...
func TestAdguardClient_GetRewritesForDomain(t *testing.T) {
	// Create test response data
	testRewrites := []Rewrite{
		{Domain: "test.vookie.net", Answer: "10.0.0.15"},
		{Domain: "test.vookie.net", Answer: "10.0.0.16"},
		{Domain: "other.vookie.net", Answer: "10.0.0.17"},
	}
